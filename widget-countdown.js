(function() {
    ...
    function interactionListeners(enable, baseColor = BASE_COLOR) {
        function handleMouseEnter() {
            if (!counting) btn.style.background = HOVER_COLOR;
        }
        function handleMouseLeave() {
            if (!counting) btn.style.background = baseColor;
        }
        function handleMouseDown() {
            if (!counting) btn.style.background = ACTIVE_COLOR;
        }
    ...
    const detectIncognito = function () {
        return new Promise(function (resolve, reject) {
            ...
            function oldSafariTest() {
                ...
                } catch (e) { return __callback(true); }
                return __callback(false);
            }
